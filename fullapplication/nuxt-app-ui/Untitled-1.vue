<template>
  <div class="">
    ...
    <form method="POST" class="justify-center">
      ...
      <button v-if="disabled" type="button" @click="editUserApi">Update</button>

      <button v-else type="button" @click="save">Add</button>
...
<script setup lang="ts">
    ...
    async save() {
const response = await useFetch(() => `http://localhost:3001/user`, {});
...
function ref(arg0: number) { throw new Error('Function not implemented.'); }
function save() { throw new Error('Function not implemented.'); } function
save() { throw new Error("Function not implemented."); } function useFetch(arg0:
() => string, arg1: {}) { throw new Error("Function not implemented."); }
